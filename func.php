...
<?php
	$arr = [1, 2, 3, 4, 5];
    echo $sum = array_sum($arr) / count($arr);
?>
...
<?php
	$arr = ['a', '-', 'b', '-', 'c', '-', 'd'];
    array_splice($arr, array_search('a', $arr), 1);
    var_dump($arr);
?>
...
<?php
    ...
    $arr = range('a', 'z');
    shuffle($arr);
    $str = implode(array_splice($arr, 0, 6), ', ');
    echo $str;
?>
...
<!-- Заполните массив 10-ю случайными числами от 1 до 100 так, чтобы они не повторялись. -->
<?php
	$arr1 = range(1, 100);
    $arr2 = shuffle($arr1);
    $arr2 = array_slice($arr1, 0, 10); 
    var_dump($arr2);
?>
